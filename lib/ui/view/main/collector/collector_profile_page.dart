...
class _CollectorProfilePageState extends State<CollectorProfilePage> {
  Future<void> _signOut(CollectorProfileProvider provider) async {
    provider.logout();
  }

  Widget build(BuildContext context) {
    return ListenerProvider<CollectorProfileProvider>(
      model: CollectorProfileProvider(context),
      builder: (CollectorProfileProvider provider) {
        return Scaffold(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  AppRouter.navToChangePasswordScreen(
                                      context, provider);
                                },
                                child: Container(
