...
import 'package:bintang_ezella_mobile_app/core/providers/collector_print_penagihan_provider.dart';
...
class PrintRiwayatPenagihanPage extends StatefulWidget {
  final String id;
  const PrintRiwayatPenagihanPage(this.id);
  @override
  _PrintRiwayatPageState createState() => _PrintRiwayatPageState();
}

class _PrintRiwayatPageState extends State<PrintRiwayatPenagihanPage> {
  ...
  Widget build(BuildContext context) {
    return ListenerProvider(
      model: CollectorPrintPenagihanProvider(context, widget.id),
      builder: (CollectorPrintPenagihanProvider provider) => provider.loading ==
              true
          ? ShimmerPage()
          : Scaffold(
              body: SafeArea(
