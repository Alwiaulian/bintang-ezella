...
class SupervisorOperatorChangePasswordPage extends StatefulWidget {
  final SupervisorProfileProvider provider;

  SupervisorOperatorChangePasswordPage(this.provider);
...
class _OperatorChangePasswordPageState
    extends State<SupervisorOperatorChangePasswordPage> {
