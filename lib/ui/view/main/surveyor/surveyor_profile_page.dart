...
class SurveyorProfilePage extends StatefulWidget {
  @override
  _SurveyorProfilePageState createState() => _SurveyorProfilePageState();
}

class _SurveyorProfilePageState extends State<SurveyorProfilePage> {
  Future<void> _signOut(SurveyorProfileProvider provider) async {
    provider.logout();
  }

  Widget build(BuildContext context) {
    return ListenerProvider<SurveyorProfileProvider>(
      model: SurveyorProfileProvider(context),
      builder: (SurveyorProfileProvider provider) {
        return Scaffold(
