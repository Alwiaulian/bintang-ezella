...
class SurveyorOperatorChangePasswordPage extends StatefulWidget {
  final SurveyorProfileProvider provider;

  SurveyorOperatorChangePasswordPage(this.provider);
...
class _OperatorChangePasswordPageState
    extends State<SurveyorOperatorChangePasswordPage> {
