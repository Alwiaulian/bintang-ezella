...
import 'package:bintang_ezella_mobile_app/ui/view/main/surveyor/riwayat_surveyor_detail_page.dart';

class RiwayatSurveyorCard extends StatelessWidget {
  final int id;
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => RiwayatSurveyorDetailPage(id),
              ),
            );
          },
          child: Column(
