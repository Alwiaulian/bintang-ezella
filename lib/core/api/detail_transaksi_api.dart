...
class DetailTransaksiApi {
  static String transaksiUrl = 'api/v1/mobile/detail-transaksi';
  
  static getDetailTransaksi(String id) async {
    String url = BaseUrl.baseUrl + transaksiUrl + '?transaksi_id=' + id;
    Dio dio = new Dio();
