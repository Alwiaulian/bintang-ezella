...
class MasterCityApi {
  static String masterCityUrl = 'api/v1/mobile/province/city';

  static getDataMasterCity(String province) async {
    String url = BaseUrl.baseUrl + masterCityUrl + '?provinsi=' + province;
    Dio dio = new Dio();
